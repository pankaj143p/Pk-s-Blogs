  ...
  return (
    ...
    <footer className="px-2 sm:px-4 py-2.5 w-full">
      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <Link href="https://github.com/frontendweb3" className="mx-auto text-gray-400 text-sm font-semibold whitespace-nowrap dark:text-white">2024 All CopyRights Pankaj Prajapati
        </Link>
